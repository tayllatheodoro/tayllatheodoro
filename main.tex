...
% === PERSONAL INFO ===
   ...
   \vspace{-0.2cm}
       ...
       \textit{R\&D Engineer} - Smart microscopy and high-throughput image analysis on Mantis, a high-throughput correlative light-sheet and label-free microscope. Built DynaTrack, a label-agnostic tracking loop that keeps developing zebrafish neuromasts in view for over 70 hours using only bright-field light~\cite{theodoro2026dynatrack}. Developed the registration, segmentation, and tracking algorithms and curated the infected live-cell dataset behind DynaCLR and DynaCell~\cite{pradeep2024contrastivelearningcellstate,hirata2025mapping,hirata-miyasaki2025embedding,kalinin2026dynacell}. Core contributor to \href{https://github.com/czbiohub-sf/biahub}{biahub}, the open-source HPC reconstruction library for Mantis data: SLURM-enabled tracking and virtual-staining CLIs, parallel phase reconstruction, registration and stabilization pipelines.
        \vspace{-0.3cm}
