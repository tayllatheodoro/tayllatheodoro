...
% === PERSONAL INFO ===
   ...
   \vspace{-0.2cm}
       ...
       \textit{R\&D Engineer} - Smart microscopy and high-throughput image analysis for live-cell imaging on Mantis, a high-throughput correlative light-sheet and label-free microscope. Built DynaTrack, a label-agnostic tracking loop that keeps developing zebrafish neuromasts in view for over 70 hours using only bright-field light~\cite{theodoro2026dynatrack}. Curated the live-cell dataset shared by DynaCLR and DynaCell: registration, virtual-staining-based segmentation, and cell tracking of infected and drug-perturbed cells~\cite{pradeep2024contrastivelearningcellstate,hirata2025mapping,hirata-miyasaki2025embedding,kalinin2026dynacell}.
        \vspace{-0.3cm}
