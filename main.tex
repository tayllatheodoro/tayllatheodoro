...
% === PERSONAL INFO ===
   ...
   \vspace{-0.2cm}
       ...
       \textit{R\&D Engineer} - 
       Developing high-throughput image analysis and smart microscopy solutions for dynamic imaging. Recent work on registration, tracking, and segmentation of infected cells reported in~\cite{pradeep2024contrastivelearningcellstate,hirata2025mapping, hirata-miyasaki2025embedding} tracking of live dynamics samples during microscopy imaging acquisition~\cite{theodoro2026dynatrack}, and evaluation of dynamic 3D virtual staining of live cells~\cite{kalinin2026dynacell}.
        \vspace{-0.3cm}

       \textbf{\href{https://lids.ic.unicamp.br/people}{LIDS - Laboratory of Image Data Science}} \hfill \textsl{Aug 2021 -- present}  \\
    ...
    \vspace{-0.2cm}
       \section{\mysidestyle Education}     
        \textbf{University of Campinas} SP, BR  \hfill \textsl{Aug 2021 - Present}\\
           \textit{M.Sc in Computer Science}
           \begin{list2}
            \item Candidacy topic: Towards Detection of Malignant Mesothelioma from 4D Magnetic Resonance Images of the Thorax~\cite{theodoro2025mesothelioma}
        ...
        \textbf{State University of Londrina} PR, BR  \hfill \textsl{Apr 2016 - Mar 2021 }\\
           ...
           \begin{list2}
            \item Dissertation: Study of Deep Learning and its Application to Medical Images\\
